...
- `Shift`: slide on the ground, wall slide on walls, invis dash while airborne
- `Left Mouse`: grab bars and climbing holds
- `R`: regenerate the obstacle course
- `T`: respawn at the latest checkpoint
